...
if (isset($_SESSION['email']) && isset($_SESSION['name']) && isset($_SESSION['id']) && isset($_SESSION['password'])) {
    // User is authenticated; their session variables are set
    $name = $_SESSION['name'];
    ...
    <nav class="navbar navbar-dark bg-dark title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="color: blue;"><b>Online Quiz System</b></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li <?php echo''; ?> > <a  style="color: red;" href="logout.php?q=welcome.php"><span style="color:red" class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Log out</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==1) 
                {
                    ...
                    <tr><td style="background-color:black;color:white;"><center><b>S.N.</b></center></td><td style="background-color:black;color:white;"><center><b>Topic</b></center></td><td style="background-color:black;color:white;"><center><b>Total question</b></center></td><td style="background-color:black;color:white;"><center><b>Marks</center></b></td><td style="background-color:black;color:white;"><center><b>Action</b></center></td></tr>';
                    $c=1;
                ...
                if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
                    ...
                    echo '<div id="error_message" style="color: red;"></div><br /><button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit</button> <button type="button" class="btn btn-danger" onclick="destroyQuiz();"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;Destroy Quiz</button>
                    </div></form>';
                }
                ?>
                <script>
                    ...
                    function destroyQuiz() {
                        if (confirm("Are you sure you want to destroy the quiz, it will record previous answer?")) {
                            window.location.href = "welcome.php?q=1"; // Redirect to welcome.php?q=1
                        } else {
                            return false; // Prevent form submission
                        }
                    }
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
                        ...
                        <tr style="color:black;"><td style="background-color:black;color:white;"><center><b>S.N.</b></center></td><td style="background-color:black;color:white;"><center><b>Quiz</b></center></td><td style="background-color:black;color:white;"><center><b>Question Solved</b></center></td><td style="background-color:black;color:white;"><center><b>Right</b></center></td><td style="background-color:black;color:white;"><center><b>Wrong<b></center></td><td style="background-color:black;color:white;"><center><b>Score</b></center></td>';
                        $c=0;
                        while($row=mysqli_fetch_array($q) )
                        {
                        $eid=$row['eid'];
                    ...
                    if(@$_GET['q']== 3) 
                    {
                        ...
                        <table class="table table-striped title1" >
                        <tr style="color:red"><td style="background-color:black;color:white;"><center><b>Rank</b></center></td><td style="background-color:black;color:white;"><center><b>Name</b></center></td><td style="background-color:black;color:white;"><center><b>Email</b></center></td><td style="background-color:black;color:white;"><center><b>Score</b></center></td></tr>';
                        $c=0;
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            $c++;
                            echo '<tr><td style="color:red"><center><b>'.$c.'</b></center></td><td style="color:blue;"><center>'.$name.'</center></td><td style="color:blue;"><center>'.$e.'</center></td><td style="color:red;"><center>'.$s.'</center></td></tr>';
                        }
                        echo '</table></div></div>';
                    }
                ?>
